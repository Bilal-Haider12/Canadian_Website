...
export default function AboutSection() {
  ...
  return (
    ...
    <section
      id="about"
      aria-label="About Canada Visa Immigration Experts"
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto mb-20 max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            We provide trusted Canada immigration consultation for students,
            skilled professionals and families looking to study, work or
            permanently settle in Canada through legal immigration pathways.
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-3xl shadow-2xl">
              ...
              <img
                src={aboutImage}
                alt="Canada immigration consultants helping students, workers and families with visa services"
                width="700"
                height="500"
                loading="lazy"
                decoding="async"
          ...
          <div>
            ...
            <h3 className="mt-6 text-4xl font-extrabold leading-tight text-gray-900">
              ...
              Trusted Canada Immigration Experts
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              At Canada Visa Experts, we help students, professionals and
              families achieve their Canadian immigration goals with honest
              advice, transparent processes and dedicated support.
            ...
            <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2">
              ...
              {[
                [FaUserGraduate, "Study Visa"],
                [FaBriefcase, "Work Permit"],
                [FaPassport, "Visitor Visa"],
                [FaUsers, "Permanent Residence"],
              ].map(([Icon, title]) => (
