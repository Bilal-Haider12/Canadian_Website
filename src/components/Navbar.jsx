  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between">
        ...
        <a
          href="#home"
          aria-label="Canada Visa Immigration Experts Home"
          className="flex items-center gap-3"
        >

          <img
            src={logo}
            alt="Canada Visa Immigration Experts Logo"
            width="80"
            height="80"
            loading="eager"
            decoding="async"
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <a
            ...
            aria-label="Contact Canada Visa Experts on WhatsApp"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Get free Canada immigration assessment"
        ...
        >
          ...
          <div className="flex flex-col p-6 gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Get free immigration assessment"
