...
function ContactSection() {
  const contacts = [
    ...
    },
    {
      ...
      description:
        "Talk instantly with our consultant via WhatsApp call/chat",
      icon: "📞",
      link:
        "https://wa.me/923001234567?text=Hi%20I%20want%20to%20talk%20with%20an%20agent",
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-10">
          {contacts.map((item, index) => (
            <a
              ...
              className="group relative bg-white rounded-[30px] border border-gray-100 shadow-lg hover:-translate-y-3 hover:shadow-2xl hover:border-red-500 transition-all duration-300 p-8"
            >
      ...
      <section className="bg-red-600 py-24">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-red-100 text-lg mb-10">
            Our experts are ready to guide you step-by-step toward your
            immigration goals.
          </p>
